...
import  {formatTimeAgo}  from '../utils/formatIimeAgo.ts'; // Adjust the import path as necessary
import HeartButton from './heart';
import CommentList from './commentList';
import { FaRegComment } from 'react-icons/fa';
import totalComments from './commentList';
import { mockComments,usertest } from '../datatest.ts'; // Adjust the import path as necessary
